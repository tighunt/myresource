...
public class CellLayout extends ViewGroup {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mFolderOuterRings.size(); i++) {
            ...
            int centerY = mTempLocation[1] + FolderRingAnimator.sPreviewSize / 2 + 12;//emirguo add 30 for haier,20120502
            ...
            centerY = mTempLocation[1] + FolderRingAnimator.sPreviewSize / 2 + 12;//emirguo add 30 for haier,20120502
            canvas.save();
