...
import com.haier.launcher2.FolderInfo.FolderListener;
...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    private static final int NUM_ITEMS_IN_PREVIEW = 4;//3 emirguo modify for haier 20120426
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        icon.mFolderName.setTextSize((float) 19.4);//emirguo add 20120411
    ...
    private void computePreviewDrawingParams(int drawableSize, int totalSize) {
        if (mIntrinsicIconSize != drawableSize || mTotalWidth != totalSize) {
            ...
            int adjustedAvailableSpace = (int) ((mAvailableSpaceInPreview / 2) * (1 + 0.5f));
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index,
        ...
        // emirguo add for haier 20120426
        switch(index){
        case 3:
        	params.transX = 7;
            params.transY = 0;
    ...
    private void drawPreviewItem(Canvas canvas, PreviewItemDrawingParams params) {
        canvas.save();
        canvas.translate(params.transX + mPreviewOffsetX, params.transY + mPreviewOffsetY + 21);//emirguo add 30,20120228
