...
public class RtkAtvViewEx extends SurfaceView {
	private String TAG = "RtkAtvViewEx";
	...
	// constructor
	public RtkAtvViewEx(Context context) {
		super(context);
		initRtkAtvView();
	}
	
	public RtkAtvViewEx(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initRtkAtvView();
	}

	public RtkAtvViewEx(Context context, AttributeSet attrs, int defStyle) {
