...
public class ImageCache {
    ...
    //add by hartley
    public static ImageCache createCache(Context context,String uniqueName)
    {
    	ImageCache imageCache = new ImageCache(context, new ImageCacheParams(uniqueName));
    	return imageCache;
    }
    ...
    //add by hartley begin:for getting cachedir name
    ...
    private void init(Context context, ImageCacheParams cacheParams) {
        ...
        cacheDirName = cacheParams.uniqueName;
    }
