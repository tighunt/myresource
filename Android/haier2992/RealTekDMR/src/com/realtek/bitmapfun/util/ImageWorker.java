...
public abstract class ImageWorker {
    ...
    //hartley add
    public void loadImage(Object data, ImageView imageView, LoadingControl loadingControl,int pos,boolean isExif)
    {
    	Bitmap bitmap = null;
        ...
        if (bitmap != null) {
            ...
            final BitmapWorkerTask task = new BitmapWorkerTask(imageView, loadingControl, pos,isExif);
  ...
  //hartley add
    		...
    		LoadingControl loadingControl,int pos,boolean isExif,int viewMode)
    {
       ...
       ;// 	surfaceView.setImageBitmap(bitmap);
        ...
        } else if (/*cancelPotentialWork(data, surfaceView)*/true) {
     ...
     //       final AsyncDrawable asyncDrawable =
     //               new AsyncDrawable(mContext.getResources(), mLoadingBitmap, task);
     //       surfaceView.setImageDrawable(asyncDrawable);
           // imageView.setBackgroundResource(R.drawable.photo_list_item_blank);
            Object[]params={data,isExif};
            task.execute(params);
        }
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        public BitmapWorkerTask(ImageView imageView,LoadingControl loadingControl,int pos, boolean isExif) {
        ...
        public void stopLoading()
        {
            if (loadingControl != null)
            {
                loadingControl.stopLoading(pos);
            }
        }
...
//            stopLoading();
        ...
        protected void onPostExecute(Bitmap bitmap) {
        	...
        	System.out.println("here we come in ONPOSTEXECUTE"+bitmap);
            ...
            else if(isSurfaceView == 1)
            {
            	bmp = bitmap;
            	System.out.println("bmppppppppppppp"+bmp.toString());
            }
        }
