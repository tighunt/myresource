...
import com.realtek.dmr.util.FileInfo;
...
public class DmrVideoPlayerActivity extends Activity{
	...
	private final String STOP_ACTION = "com.android.DMRService.stop"; //DMC
			...
			public void handleMessage(Message msg) {
	    		switch(msg.what){
	        		...
	        		case MSG_SET_PLAYANDPAUSE_ICONTOPAUSE : {
	        			play.setImageResource(R.drawable.video_menu_button7);
	        			playStatus.setBackgroundResource(R.drawable.video_pause_status);
	        		} break;
	        		case MSG_SET_PLAYANDPAUSE_ICONTOPLAY: {
	        			play.setImageResource(R.drawable.video_menu_button7_1);
	        			playStatus.setBackgroundResource(R.drawable.play_arrows_img);
	        		} break;
...
//		        		break;
    ...
    */
    ...
    public void findViews() {
    	...
    	play = (ImageView)MovieBannerView.findViewById(R.id.c_playandpause);
    	play.requestFocus();
    	...
    	playStatus = (ImageView)findViewById(R.id.PlayArrowsImg);
    	
    	menu = (ImageView) findViewById(R.id.main_menu);
    	
    	progressDialog = new ProgressDialog(this, R.style.custom_dialog_1);
    	progressDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
    	progressDialog.setCancelable(true);
    	progressDialog.setMessage(getResources().getString(R.string.hint_wait));
    	...
    	if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            short_msg = new ConfirmMessage(DmrVideoPlayerActivity.this,452,150);
