...
public class IdolListActivity extends BaseActivity{
    ...
    private final static String TAG = "IdolListActivity";
    ...
    private void initTencetData(){
            mQData = idollist(getInstance(), "30", "0", "0");
            Log.v(TAG, "start to init Tencent, Sir!");
            //Log.v(TAG, mQData);
            mQStatusList = getQStatusList(mQData);
            mQAdapter = new FansListAdapter(IdolListActivity.this, mQStatusList);
            ...
            @Override
                ...
                mBundle.putSerializable("detail",mQStatusList.get(position-1));  
                    intent.putExtras(mBundle);
                            intent.setClass(IdolListActivity.this, QStatusDetailActivity.class);
