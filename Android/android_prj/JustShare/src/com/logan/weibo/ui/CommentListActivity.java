...
import com.logan.weibo.adapter.CommentListAdapter;
...
/**
 * 拉取单条微博消息的评论列表，根据源微博id获取指定条数的评论消息
...
public class CommentListActivity extends BaseActivity {
    ...
    public final static int COMMENT_LIST = 2;
    // ----------头部工具栏-----------------------//
    ...
    CommentListAdapter mQAdapter =null;
    	...
    	tweet = (ImageView) findViewById(R.id.weibo_headbar_tweet);
            tweet.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                			...
                			intent.putExtra(WHOAMI, COMMENT_LIST);
                            intent.setClass(CommentListActivity.this, Tweet.class);
    ...
    private void initTencetData(String rootid){
            ...
            mQData = reList(getInstance(), "1", rootid, String.valueOf(pageFlag), pageTime, "100", "0");
            mQStatusList = getQStatusList(mQData);
            mQAdapter = new CommentListAdapter(CommentListActivity.this, mQStatusList);
            ...
            @Override
                ...
                mBundle.putSerializable("detail",mQStatusList.get(position-1));  
                    intent.putExtras(mBundle);
                            intent.setClass(CommentListActivity.this, QStatusDetailActivity.class);
                    ...
                    public void run() {                             
                            ...
                            //Log.v(TAG, "try to load data...");
                                    try {                                   
                                            ...
                                            mQData = reList(getInstance(), "1", id, String.valueOf(pageflag), pageTime, "100", "0");
