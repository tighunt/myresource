...
import com.logan.weibo.adapter.RetweetListAdapter;
...
/**
 * 拉取单条微博消息的转播列表，根据源微博id获取指定条数的转播消息
 * @author Logan <a href="https://github.com/Logan676/JustShare"/>
 *   
 * @version 1.0 
 *  
 */
public class RetweetListActivity extends BaseActivity {
	
	private final static String TAG = "RetweetListActivity";
	...
	RetweetListAdapter mQAdapter =null;
	...
	private void initHeader(){
		...
		tweet.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra(WHOAMI, RETWEET_LIST);
				intent.setClass(RetweetListActivity.this, Tweet.class);
	...
	private void initTencetData(String rootid){
		//Log.v(TAG, "start to init Tencent, Sir!");
		mQData = reList(getInstance(), "0", rootid, String.valueOf(pageFlag), pageTime, "100", "0");
		mQStatusList = getQStatusList(mQData);
		mQAdapter = new RetweetListAdapter(RetweetListActivity.this, mQStatusList);
		...
		pullToRefreshListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				intent.setClass(RetweetListActivity.this, QStatusDetailActivity.class);
			...
			public void run() {				
				...
				//Log.v(TAG, "try to load data...");
					try {					
						...
						mQData = reList(getInstance(), "0", id, String.valueOf(pageflag), pageTime, "100", "0");
