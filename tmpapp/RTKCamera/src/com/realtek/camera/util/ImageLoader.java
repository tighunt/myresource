...
public class ImageLoader {
    ...
    public static final Callback CALLBACK_FADE_IN = new Callback() {
        ...
        private void fade(View view, int visibility, float startAlpha, float endAlpha) {
    ...
    private ImageLoader(int maxThreadCount) {
        ...
        if (VERBOSE) {
            Log.i(TAG, String.format("Cache size = %d, Maximum memory usage = %d", CACHE_SIZE,
                    MAX_MEMORY_USAGE));
        }
    }
