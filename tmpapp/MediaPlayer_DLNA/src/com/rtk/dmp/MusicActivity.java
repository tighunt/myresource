...
public class MusicActivity extends Activity {
	...
	private void onGui() {
		...
		//show gui always:bug id 0072239
	}
	...
	protected BroadcastReceiver serviceReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			time_now.setText(Util.toTime(timePosition) );
				...
				AndroidMessageBox.alertMessageOnly(MusicActivity.this, getResources().getString(R.string.msg_unsupport), 
...
private class SeekBarLisener implements SeekBar.OnSeekBarChangeListener{
    ...
    private void setGuiFocus(View view){
		//backGui();
        switch (view.getId()) {
        /*case R.id.gui_last:
        	gui_back = gui_last;
