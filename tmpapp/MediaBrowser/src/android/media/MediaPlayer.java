...
public class MediaPlayer
{
    ...
    public void setDisplay(SurfaceHolder sh) {
        ...
        if (sh != null) {
            ...
            {
                Rect surface_layout = new Rect();
                Point screen_dim=new Point();

                /*if(sh.getLayoutInfo(surface_layout,screen_dim) == 0)
                {
                    Log.w(TAG, "jason Surface Layout : left = "+surface_layout.left+",top = "+surface_layout.top+",width = "+surface_layout.width()+",height = "+surface_layout.height());
                    Log.w(TAG, "jason screen : width = "+screen_dim.x+",height = "+screen_dim.y);
                    setLayoutInfo(surface_layout.left,surface_layout.top,surface_layout.width(),surface_layout.height(),screen_dim.x,screen_dim.y);
                }
                else
                {
                    Log.w(TAG, "jason No Media Layout Info");
                }*/
            }
        } else {
            surface = null;
   ...
   /**
     * @hide
     * Gets the speed of  downloading file.
     *
     * @return the speed (kb)
     */
     ...
     * @return 0 : ok , -1: fail
     */
    public native void fastforward(int speed);
    /**
     * set rewind speed
     *
     * @return 0 : ok , -1: fail
     */
    public native void fastrewind(int speed);
    /*
     * getSubtitleInfo
   ...
   /*
     ...
     * @return void
     */
    public native void setSubtitleInfo(int streamNum,int enable,int textEncoding,int textColor,int fontSize);
    /*
     * getAudioTrackInfo
     * @param streamNum : 1-based. -1 means current audio stream
     * @return int array:
     ...
     *    3 : type - refert to AUDIO_TYPE_TABLE.
     ...
     *         AUDIO_TYPE_TABLE - 
     *                 -1 : unknown
     *         0x00001000 : MPEG/MPEG2/MPEG2 with extension/MPEG2 without extension
     *         0x00001001 : Dolby AC3
     *         0x00001002 : Dolby Digital Plus
     *         0x00001003 : PCM/littel endian PCM
     *         0x00001004 : DTS
     *         0x00001005 : DTS HD
     *         0x00001006 : AAC/LATM AAC
     *         0x00001007 : RAW AAC
     *         0x00001008 : MP4
     *         0x00001009 : WMA
     *         0x0000100A : WMAPRO
     *         0x0000100B : OGG
     *         0x0000100C : RealAudio Cook
     *         0x0000100D : RealAudio Lossless
     *         0x0000100E : ADPCM
     *         0x0000100F : ULAW
     *         0x00001010 : ALAW
     *         0x00001011 : FLAC
...
/*
get Media Layout (int surface_x,int surface_y,int surface_w,int surface_h)
    screen size (int screen_x,int screen_y)
*/
    public native void setLayoutInfo(int surface_x,int surface_y,int surface_w,int surface_h,int screen_x,int screen_y);
    /**
     *@hide
     * enable/ disable seamless playback
     * if seamless playback is enabled, scaler will keep the last frame on the screen
     * Therefore, media resolution and display timeing must keep unchanged
     * Otherwise, you might see garbage on the screen.
     * @param bEnable : ture to enable and false to disable seamless playback
     * @return void
     *
     */
    public native void setPlaySeamless(boolean bEnable);

/**
	 * Play the title given by user 
	 * @param titleNum : 1-based.
	 * @return void
	 */
	public native void execPlayTitle(int titleNum);
	/**
	 * Play the Chapter given by user 
	 * @param titleNum : 1-based, chapterNum : 1-based.
	 * @return void
	 */
	public native void execPlayChapter(int titleNum, int chapterNum);
	/**
	 * Play next Chapter
	 * @return void
	 */
	public native void execPlayNextChapter();
	/**
	 * Play previous Chapter
	 * @return void
	 */
	public native void execPlayPrevChapter();
	/**
	 * Play the Auto generated Chapter
	 * @param titleNum : 1-based, chapterNum : 1-based.
	 * @return void
	 */
	public native void execPlayAutoChapter(int titleNum, int chapterNum);
	/**
	 * Reset Divx state
	 * @return void
	 */
	public native void execResetDivxState();
    /**
	...
	/** MediaPlayer is entering trick play mode
     * @see android.media.MediaPlayer.OnInfoListener
     */
	public static final int MEDIA_INFO_FE_PB_ENTER_TRICKPLAY = 720;

	/** MediaPlayer is leaving trick play mode
     * @see android.media.MediaPlayer.OnInfoListener
     */
    public static final int MEDIA_INFO_FE_PB_LEAVE_TRICKPLAY = 721;

	/** MediaPlayer resets speed
     * @see android.media.MediaPlayer.OnInfoListener
     */
     public static final int MEDIA_INFO_FE_PB_RESET_SPEED = 722;
