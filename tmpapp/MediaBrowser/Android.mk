...
#
ifeq ($(filter rtd298x_tv015,$(TARGET_DEVICE)),)
...
LOCAL_STATIC_JAVA_LIBRARIES := libandroidsupportv4_tsb
...
include $(CLEAR_VARS)
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := libandroidsupportv4_tsb:libs/android-support-v4.jar
