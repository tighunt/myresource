...
final class Utilities {
    ...
    private static int sIconWidth2 = -1;
    private static int sIconHeight2 = -1;
    private static int sIconTextureWidth = -1;
    private static int sIconTextureHeight = -1;
    private static int sIconTextureWidth2 = -1;
    private static int sIconTextureHeight2 = -1;
    ...
    static Bitmap createIconBitmap(Bitmap icon, Context context) {
		...
		Log.e("tag","txtw"+textureWidth+"txtH"+textureHeight+"sw"+sourceWidth+"sh"+sourceHeight);
    ...
    static Bitmap createIconBitmap2(Bitmap icon, Context context) {
        int textureWidth = sIconTextureWidth/2;
        int textureHeight = sIconTextureHeight/2;
        int sourceWidth = icon.getWidth();
        int sourceHeight = icon.getHeight();
        if (sourceWidth > textureWidth && sourceHeight > textureHeight) {
            // Icon is bigger than it should be; clip it (solves the GB->ICS migration case)
    ...
    static int getsIconWidth2()
    {
    	return sIconWidth2;
    }
    
    static int getsIconWidth()
    {
    	return sIconWidth;
    }
    
    static int getsIconHeight()
    {
    	return sIconHeight;
    }
    static Bitmap createIconBitmap2(Drawable icon, Context context) {
        synchronized (sCanvas) { // we share the statics :-(
            if (sIconWidth2 == -1) {
                initStatics(context);
            }

            int width = (int)(sIconWidth2);
            int height = (int)(sIconHeight2);
            ...
            // no intrinsic size --> use default size
            int textureWidth = sIconTextureWidth2;
            int textureHeight = sIconTextureHeight2;
    ...
    private static void initStatics(Context context) {
        ...
        sIconWidth2 = sIconHeight2 = (int) resources.getDimension(R.dimen.allapp_icon_size);
        sIconTextureWidth = sIconTextureHeight = sIconWidth;
        sIconTextureWidth2 = sIconTextureHeight2 = sIconWidth2;
