...
import com.tsb.launcher.FolderInfo.FolderListener;
...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    public void performCreateAnimation(final ShortcutInfo destInfo, final View destView,
        ...
        if(destView instanceof IconTextView)
        	animateDrawable= ((IconTextView) destView).getIcon();
        else if(destView instanceof AllAppIconTextView){
        	animateDrawable= ((AllAppIconTextView) destView).getIcon();
        }
        else
        	animateDrawable= ((TextView) destView).getBackground();
    ...
    public void performDestroyAnimation(final View finalView, Runnable onCompleteRunnable) {
        Drawable animateDrawable = ((TextView) finalView).getBackground();
        computePreviewDrawingParams(animateDrawable.getIntrinsicWidth(), 
