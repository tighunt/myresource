...
public abstract class PagedViewWithDraggableItems extends PagedView
    ...
    public PagedViewWithDraggableItems(Context context, AttributeSet attrs,boolean isapp) {
        this(context, attrs, 0,isapp);
    }
    ...
    public PagedViewWithDraggableItems(Context context, AttributeSet attrs, int defStyle,boolean isapp) {
        super(context, attrs, defStyle,isapp);
        mLauncher = (Launcher) context;
    }
