...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    protected boolean createAndAddShortcut(ShortcutInfo item) {
        final BubbleTextView textView =
            (BubbleTextView) mInflater.inflate(R.layout.hotseat_application, this, false);
        //textView.setCompoundDrawablesWithIntrinsicBounds(null,
               // new FastBitmapDrawable(item.getIcon(mIconCache)), null, null);
        textView.setBackground(new FastBitmapDrawable(item.getIcon(mIconCache)));
               ...
               View child = null;
                ...
                if (getItemCount() == 1) {
                    ...
                    child = mLauncher.createShortcut(R.layout.application, cellLayout,
                            finalItem);
                	int type = getType(mInfo.cellX,mInfo.cellY,finalItem.spanX,finalItem.spanY);
                	if(type == 0)
                	{        
                		child = mLauncher.createShortcut(R.layout.application, cellLayout,
                	...
                	{
                		child = mLauncher.createShortcut(R.layout.leftapplication, cellLayout,
               					(ShortcutInfo) finalItem);
                	}else if(type == 2)
                		{
                		child = mLauncher.createShortcut(R.layout.rightapplication, cellLayout,
               					(ShortcutInfo) finalItem);
                		}
    ...
    public int getType(int oldX,int oldY,int spanX,int spanY){
    	int type1=0;
    	if(oldX == 0)
    	{
    		if(oldY + spanY == 3){
