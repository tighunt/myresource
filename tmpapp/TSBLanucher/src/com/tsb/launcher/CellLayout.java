...
public class CellLayout extends ViewGroup {
    ...
    private Drawable mNormalBackground_f;
    private Drawable mActiveGlowBackground_f;
    ...
    private boolean mIsFocusPage = false; //same index as homescreen
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mNormalBackground_f = res.getDrawable(R.drawable.homescreen_blue_normal_holo_focus);
        mActiveGlowBackground_f = res.getDrawable(R.drawable.homescreen_blue_strong_holo_focus);
        ...
        mNormalBackground_f.setFilterBitmap(true);
        mActiveGlowBackground_f.setFilterBitmap(true);
    ...
    public boolean addViewToCellLayout(View child, int index, int childId, LayoutParams params,
        ...
        if (child instanceof IconTextView) {
        	IconTextView bubbleChild = (IconTextView) child;
    ...
    public void setBackgroundAlphaMultiplier(float multiplier,boolean is) {
        if (mBackgroundAlphaMultiplier != multiplier) {
            mBackgroundAlphaMultiplier = multiplier;
            mIsFocusPage = is;
            invalidate();
    ...
    public void setBackgroundAlpha(float alpha,boolean is) {
    	mIsFocusPage = is;
        if (mBackgroundAlpha != alpha) {
            mBackgroundAlpha = alpha;
            invalidate();
