...
public class FocusHelper {
    ...
    private static View findIndexOfIcon(ArrayList<View> views, int i, int delta) {
        ...
        while (0 <= newI && newI < count) {
            ...
            if (newV instanceof BubbleTextView || newV instanceof FolderIcon  || newV instanceof IconTextView) {
                return newV;
            }
            newI += delta;
        }
            ...
            case KeyEvent.KEYCODE_DPAD_LEFT:
                if (handleKeyEvent) {
                	...
                	if(info!=null){
                		...
                		if(pageIndex == 2 && cellX == 4){
                			workspace.setTvFocus();
                			return true;
                		}
                	}
